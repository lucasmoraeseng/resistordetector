...
def TestImage(TestPath, Sample,ResultFilePath,ResultPath,CroppedPath,Cascade,ShowImage):
    ...
    objRes = Cascade.detectMultiScale(
        img,
        scaleFactor=1.015,
        minNeighbors=30,
        minSize=(100, 100),
...
#objCascade = cv2.CascadeClassifier("haarcascade_frontalface_alt2.xml")
#objCascade = cv2.CascadeClassifier("HaarXML/ResGood_20cascade.xml")
